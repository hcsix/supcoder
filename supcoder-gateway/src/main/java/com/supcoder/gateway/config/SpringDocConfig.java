package com.supcoder.gateway.config;
...
class SwaggerDocRegister extends Subscriber<InstancesChangeEvent>
{
    ...
    private final static String[] EXCLUDE_ROUTES = new String[] { "supcoder-gateway", "supcoder-auth", "supcoder-file", "supcoder-monitor" };
