...
from scripts.fetch_lottery import format_lottery_data
...
def send_lottery_data(lottery_data):
    ...
    # 发送POST请求
    response = requests.pull("http://127.0.0.1/api/lottery", json=data)
...
if __name__ == "__main__":
    ...
    json = format_lottery_data(lottery_data)
    send_lottery_data(json)